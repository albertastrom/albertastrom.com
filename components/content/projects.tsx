  ...
  return (
    <div className="mt-8 px-4 py-2 rounded-lg bg-white border border-gray-200 mb-6 shadow-lg">
      ...
      <Project 
        ...
        links={[{ url: "https://trinket.world/", title: "trinket.world" }]}
      ...
      <Project
        ...
        links={[{ url: "https://github.com/RachelJiarui/TruthAgent", title: "github.com/RachelJiarui/TruthAgent" }]}
        imageUrl="https://www.uncovercolorado.com/wp-content/uploads/2013/12/Aspen-Highlands-Bowl-Hike-800x400.jpg"
      ...
      <Project
        ...
        links={[{ url: "https://www.crinteractive.org", title: "crinteractive.org" }]}
        imageUrl="https://www.uncovercolorado.com/wp-content/uploads/2013/12/Aspen-Highlands-Bowl-Hike-800x400.jpg"
