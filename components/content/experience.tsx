...
const Experience = () => {
  return (
    <div className="mt-8 px-4 py-2 rounded-lg bg-white border border-gray-200 shadow-lg">
        ...
        <Position title="CS Teaching Assistant" timeframe="Feb. 2023 - May 2024" company="Colby CS" description="CS231: Data Structures and Algorithms, CS333: Programming Languages" link="https://cs.colby.edu/courses/S24/231/" linkTitle="cs.colby.edu"/>
